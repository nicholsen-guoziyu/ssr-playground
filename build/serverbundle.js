...
/* harmony import */ var _ClientAppSSR_Hello__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../ClientAppSSR/Hello */ "./ClientAppSSR/Hello.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function (req) {
  ...
  var content = Object(react_dom_server__WEBPACK_IMPORTED_MODULE_1__["renderToString"])( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["StaticRouter"], {
    location: req.path,
    context: context
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ClientAppSSR_Hello__WEBPACK_IMPORTED_MODULE_3__["default"], {
    name: "World"
  })));
  return {
...
app.get('*', function (req, res) {
  var rendererInstance = Object(_Renderer__WEBPACK_IMPORTED_MODULE_0__["default"])(req);

  if (rendererInstance.routestatus == 404) {
    res.status(404).end("Not found, 404 status returned");
  } else {
    res.send(Object(_Renderer__WEBPACK_IMPORTED_MODULE_0__["default"])(req).htmlcode);
  }
});
